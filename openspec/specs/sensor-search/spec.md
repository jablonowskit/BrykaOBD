...
Searchable sensor catalog and user-selected live poll list on the Szukaj tab, with narrow-filter preview so users can see ECU responses before adding a metric.
