...
Defines reading and clearing of stored OBD-II Diagnostic Trouble Codes via ELM327 Mode 03 and Mode 04, including SAE-style code decoding, dashboard UI actions with confirmation for clear, and safe interleaving with Mode 01 polling on the same session.
...
- GIVEN ELM reply containing `43` with payload encoding P0301 (e.g. `43 02 03 01 04 20` includes P0301)
